...
description: "Start-of-session project recap: summarize progress, surface what's next,
  flag risks and decisions due for review, and orient the user for today's work."
allowed-tools:
  - Read
  - Write
  - Edit
